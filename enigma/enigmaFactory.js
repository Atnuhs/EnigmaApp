import { Rotor, PlugBoard, Reflector, Enigma } from "./enigma.js";
...
class EnigmaFactory {
    ...
    enigmaInitializedWithDailyKey(dailyKey) {
        ...
        const plugBoard = new PlugBoard(
            scramblerPreset[dailyKey.plugBoardScramblerPreset()]
        )
    ...
    enigmaInitializedWithCommunicationKey(communicationKey, enigma) {
        return enigma.resetRotorsAngle(
            communicationKey.RotorsAngle()
        )
    }
}
